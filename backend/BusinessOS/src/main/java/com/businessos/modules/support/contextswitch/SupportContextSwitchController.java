...
public class SupportContextSwitchController {
    ...
    public ResponseEntity<SupportContextSwitchResponse> switchContext(@Valid @RequestBody SupportContextSwitchRequest request) {
        return ResponseEntity.ok(service.switchContext(request));
    }
