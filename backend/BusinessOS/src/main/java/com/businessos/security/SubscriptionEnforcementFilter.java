...
public class SubscriptionEnforcementFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (user != null && companyId != null) {
            ...
            if (company != null && company.isTrialExpired()) {
                // 4. Check exceptions for expired companies
                boolean isAllowedEndpoint = uri.matches("^/api/support/tickets.*") ||
                ...
                if (!isAllowedEndpoint) {
                    ...
                    error.put("error", "Subscription Expired");
                    error.put("message", "Your subscription or trial has expired. The system is in read-only mode. Please process payment or contact support to continue.");
