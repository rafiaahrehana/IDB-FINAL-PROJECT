...
export class LeaveService {
  ...
  list(page = 0): Observable<PagedResponse<AttendanceLeave>> {
     return this.api.getPaged(this.endpoint, page, 20); }

  getById(id: number): Observable<AttendanceLeave> {
     return this.api.get(`${this.endpoint}/${id}`); }

  create(payload: any): Observable<AttendanceLeave> {
